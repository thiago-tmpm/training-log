...
const EXERCISES = {
  lower_1: [
    { id: 'l1_1', name: 'Adutor',                                          sets: 2, repRange: '8-12' },
    { id: 'l1_2', name: 'Agachamento Guiado - Hack',                       sets: 3, repRange: '5-8'  },
    { id: 'l1_3', name: 'Cadeira Flexora - Máquina Articulada',            sets: 3, repRange: '6-10' },
    { id: 'l1_4', name: 'Extensora - Cadeira Articulada - Unilateral',     sets: 3, repRange: '8-12' },
    { id: 'l1_5', name: 'Flexora em Pé - Máquina Articulada - Unilateral', sets: 3, repRange: '8-12' },
    { id: 'l1_6', name: 'Panturrilha',                                     sets: 4, repRange: '8-12' }
  ],
  push: [
    ...
    { id: 'pu_4', name: 'Elevação Frontal Corda - Polia Baixa',             sets: 2, repRange: '8-12'  },
  ...
  pull: [
    ...
    { id: 'pl_8', name: 'Puxada Supinada',                         sets: 3, repRange: '8-12'  },
    { id: 'pl_3', name: 'Remada Articulada Unilateral - Neutra',   sets: 3, repRange: '6-10'  },
  ...
  lower_2: [
    ...
    { id: 'l2_3', name: 'Abdutor Cadeira Articulada',   sets: 3, repRange: '8-12' },
    { id: 'l2_4', name: 'Mesa Flexora',                 sets: 3, repRange: '8-12' },
    { id: 'l2_5', name: 'Cadeira Extensora Unilateral', sets: 2, repRange: '6-10' },
    { id: 'l2_6', name: 'Panturrilha',                  sets: 4, repRange: '8-12' }
  ],
  upper_body: [
    ...
    { id: 'ub_8', name: 'Remada Alta Jayme (Halter)',                  sets: 3, repRange: '8-12' },
    { id: 'ub_7', name: 'Tríceps Francês Sentado Polia',               sets: 2, repRange: '8-12' }
  ]
};

// ── RETIRED EXERCISES ──
// Not used by the app. Exists so retired IDs are never reused and a returning
// exercise can be restored with its original ID intact. To bring one back,
// move its line into the appropriate EXERCISES day with its original id.
const RETIRED_EXERCISES = {
  pl_2: { name: 'Puxada Alta Unilateral',           day: 'pull',       sets: 3, repRange: '8-12' },
  ub_6: { name: 'Elevação Lateral Polia Unilateral', day: 'upper_body', sets: 3, repRange: '8-12' }
};
